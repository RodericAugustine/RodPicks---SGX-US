"""
RodPicks-SG v2 — Price Appreciation Strategy for SGX Stocks
=========================================================
...
Usage:
    python rodpickssg_v2.py                    # today's top-5 signal + dashboard
    python rodpickssg_v2.py --top 10           # top 10
    python rodpickssg_v2.py --backtest         # 2-year backtest
    python rodpickssg_v2.py --backtest --start 2023-01-01 --capital 20000
...
def run_signal(top_n: int = 5) -> pd.DataFrame:
    ...
    print(f"\n{'='*56}")
    print(f"  RodPicks-SG v2  |  Price Appreciation  |  {today}")
...
<title>RodPicks-SG — SGX Monthly Signal</title>
<style>
...
<header>
  <div>
    <h1>RodPicks-SG v2 &nbsp; SGX Monthly Signal</h1>
...
<footer style="margin-top:24px">
  RodPicks-SG v2 &nbsp;·&nbsp; SGX Price Strategy &nbsp;·&nbsp; Data: yfinance &nbsp;·&nbsp;
...
def run_backtest(start: str = None, capital: float = 50_000, top_n: int = 5, anchor: str = None):
    ...
    print(f"\n{'='*56}")
    print(f"  RodPicks-SG v2 Backtest  {start} → {date.today()}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="RodPicks-SG v2 — Price Appreciation Strategy")

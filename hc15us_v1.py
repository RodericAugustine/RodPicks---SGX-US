"""
HC15-US v1 — Monthly Price Momentum Strategy for US Stocks
===========================================================
...
Usage:
    python hc15us_v1.py                    # today's top-5 signal + dashboard
    python hc15us_v1.py --top 10           # top 10
    python hc15us_v1.py --backtest         # 2-year backtest
    python hc15us_v1.py --backtest --start 2024-01-01 --capital 25000
"""
...
def run_signal(top_n: int = 5) -> pd.DataFrame:
    ...
    print(f"\n{'='*58}")
    print(f"  HC15-US v1  |  Price Momentum  |  {today}")
...
<title>HC15-US — US Monthly Signal</title>
<style>
...
<header>
  <div>
    <h1>HC15-US v1 &nbsp; US Monthly Signal</h1>
...
<footer style="margin-top:24px">
  HC15-US v1 &nbsp;·&nbsp; US Price Strategy &nbsp;·&nbsp; 120 stocks &nbsp;·&nbsp;
...
def run_backtest(start: str = None, capital: float = 25_000, top_n: int = 5):
    ...
    print(f"\n{'='*58}")
    print(f"  HC15-US v1 Backtest  {start} → {date.today()}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="HC15-US v1 — US Price Momentum Strategy")
